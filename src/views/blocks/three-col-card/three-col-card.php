<?php
/**
 * Three column card with description Template
 *
 * @package SDEV
 * @subpackage SDEV WP
 ...
 */  
    ...
    $tiles = get_field('tiles_content');

    // Create class attribute allowing for custom "className" and "align" values.
    $class_name = 'block--custom-layout__three-col-card';
...
?>
    ...
    <div class="block--custom-layout <?= $class_name ?>" <?= $anchor ?> style="background-image: url('<?= $background; ?>');"> 
        <div class="container-block">
            ...
            <?php if ($cta_type === 'link') : 
                ...
                <?php else : if($cta_text) : ?>
                    <div class="cta-wrap <?= $cta_alignment; ?>">
                        <a data-fancybox data-src="#tiles-form" href="javascript:;" class="btn-default primary" style="background-color: <?= $cta_background; ?>; color: <?= $cta_text_color; ?>">
                            <?= $cta_text; ?>
                        </a>
                    </div>
                <?php endif; endif; ?>
        ...
        <div class="hidden">
            <div id="tiles-form" class="popup-form-container">
                <?= $cta_form ?>
            </div>
        </div>
    </div>
